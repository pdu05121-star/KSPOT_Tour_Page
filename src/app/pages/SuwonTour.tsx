...
const SPOTS: Record<Lang, SpotItem[]> = {
  ko: [
    { no: "01", emoji: "🎬", title: "몽테드 카페", subtitle: "솔이네 비디오가게 앞 · 노란 우산씬",
      ...
      caution: "영업시간 10:00–19:00 · 매주 수요일 휴무", image: monteDPipImg, imgPosition: "bottom" },
  ...
  en: [
    { no: "01", emoji: "🎬", title: "Monde Café", subtitle: "In front of Sol's video store · the yellow umbrella scene",
      ...
      caution: "Open 10:00–19:00 · Closed Wednesdays", image: monteDPipImg, imgPosition: "bottom" },
  ...
  ja: [
    { no: "01", emoji: "🎬", title: "モンテドカフェ", subtitle: "ソルの家のビデオ店前・黄色い傘のシーン",
      ...
      caution: "営業時間10:00–19:00 · 毎週水曜休み", image: monteDPipImg, imgPosition: "bottom" },
  ...
  zh: [
    { no: "01", emoji: "🎬", title: "Monde咖啡", subtitle: "Sol家录像店门前·黄色雨伞那场戏",
      ...
      caution: "营业时间10:00–19:00 · 每周三休息", image: monteDPipImg, imgPosition: "bottom" },
  ...
  vi: [
    { no: "01", emoji: "🎬", title: "Monde Café", subtitle: "Trước tiệm băng đĩa của Sol · Cảnh ô vàng",
      ...
      caution: "Giờ mở cửa 10:00–19:00 · Đóng cửa thứ Tư hàng tuần", image: monteDPipImg, imgPosition: "bottom" },
