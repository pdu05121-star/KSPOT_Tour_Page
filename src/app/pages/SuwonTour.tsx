...
const SPOTS: Record<Lang, SpotItem[]> = {
  ko: [
    { no: "01", emoji: "🎬", title: "몽테드 카페", subtitle: "솔이네 비디오가게 앞 · 노란 우산씬",
      ...
      caution: "영업시간 10:00–19:00 · 매주 수요일 휴무", image: monteDPipImg, imgAspect: "3 / 2" },
    ...
    { no: "03", emoji: "🚲", title: "방화수류정", subtitle: "자전거를 가르쳐주던 그 자리",
      ...
      caution: "24시간 개방 · 휴무 없음", image: bangwhasuryujeongPipImg },
    { no: "04", emoji: "🧱", title: "행궁동 벽화마을", subtitle: "설레는 벽쿵씬 그 골목",
      ...
      caution: "개별 가게는 방문 시 영업 여부 확인 필요", image: muralPipImg },
    ...
    { no: "06", emoji: "🛍️", title: "행리단길", subtitle: "매일 지나던 그 등하굣길",
      ...
      caution: "개별 매장은 방문 시 영업 여부 확인 필요", image: haengridangilPipImg },
  ],
  en: [
    { no: "01", emoji: "🎬", title: "Monde Café", subtitle: "In front of Sol's video store · the yellow umbrella scene",
      ...
      caution: "Open 10:00–19:00 · Closed Wednesdays", image: monteDPipImg, imgAspect: "3 / 2" },
    ...
    { no: "03", emoji: "🚲", title: "Banghwasuryujeong", subtitle: "Where he taught her to ride a bike",
      ...
      caution: "Open 24 hours · No closed days", image: bangwhasuryujeongPipImg },
    { no: "04", emoji: "🧱", title: "Haenggung-dong Mural Village", subtitle: "The alley of the flustering wall-kiss scene",
      ...
      caution: "Check individual shop hours on visit", image: muralPipImg },
    ...
    { no: "06", emoji: "🛍️", title: "Haengridan-gil", subtitle: "The street she walked to school every day",
      ...
      caution: "Check individual shop hours on visit", image: haengridangilPipImg },
  ],
  ja: [
    { no: "01", emoji: "🎬", title: "モンテドカフェ", subtitle: "ソルの家のビデオ店前・黄色い傘のシーン",
      ...
      caution: "営業時間10:00–19:00 · 毎週水曜休み", image: monteDPipImg, imgAspect: "3 / 2" },
    ...
    { no: "03", emoji: "🚲", title: "訪花随柳亭", subtitle: "自転車を教えてもらったその場所",
      ...
      caution: "24時間開放 · 休みなし", image: bangwhasuryujeongPipImg },
    { no: "04", emoji: "🧱", title: "行宮洞壁画村", subtitle: "ドキドキする壁ドンシーンのあの路地",
      ...
      caution: "個別の店舗は訪問時に営業確認が必要", image: muralPipImg },
    ...
    { no: "06", emoji: "🛍️", title: "行理団街", subtitle: "毎日通っていたあの通学路",
      ...
      caution: "個別の店舗は訪問時に営業確認が必要", image: haengridangilPipImg },
  ],
  zh: [
    { no: "01", emoji: "🎬", title: "Monde咖啡", subtitle: "Sol家录像店门前·黄色雨伞那场戏",
      ...
      caution: "营业时间10:00–19:00 · 每周三休息", image: monteDPipImg, imgAspect: "3 / 2" },
    ...
    { no: "03", emoji: "🚲", title: "访花随柳亭", subtitle: "教她骑自行车的地方",
      ...
      caution: "24小时开放 · 无休息日", image: bangwhasuryujeongPipImg },
    { no: "04", emoji: "🧱", title: "行宫洞壁画村", subtitle: "心动壁咚场景的那条巷子",
      ...
      caution: "个别店铺需现场确认营业情况", image: muralPipImg },
    ...
    { no: "06", emoji: "🛍️", title: "行理团街", subtitle: "每天走过的那条上学路",
      ...
      caution: "个别店铺需现场确认营业情况", image: haengridangilPipImg },
  ],
  vi: [
    { no: "01", emoji: "🎬", title: "Monde Café", subtitle: "Trước tiệm băng đĩa của Sol · Cảnh ô vàng",
      ...
      caution: "Giờ mở cửa 10:00–19:00 · Đóng cửa thứ Tư hàng tuần", image: monteDPipImg, imgAspect: "3 / 2" },
    ...
    { no: "03", emoji: "🚲", title: "Banghwasuryujeong", subtitle: "Nơi anh ấy dạy cô đi xe đạp",
      ...
      caution: "Mở cửa 24/24 · Không ngày nghỉ", image: bangwhasuryujeongPipImg },
    { no: "04", emoji: "🧱", title: "Làng bích họa Haenggung-dong", subtitle: "Con hẻm nhỏ với cảnh ép tường lãng mạn",
      ...
      caution: "Cần xác nhận giờ mở cửa của từng cửa hàng riêng lẻ khi ghé thăm", image: muralPipImg },
    ...
    { no: "06", emoji: "🛍️", title: "Haengridan-gil", subtitle: "Con đường đến trường mỗi ngày",
      ...
      caution: "Cần xác nhận giờ mở cửa của từng cửa hàng riêng lẻ khi ghé thăm", image: haengridangilPipImg },
  ],
};
