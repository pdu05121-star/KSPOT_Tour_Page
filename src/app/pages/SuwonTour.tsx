...
import haengridangilImg from "@/assets/suwon/행리단길.webp";
import monteDPipImg from "@/assets/suwon/몽테드_PIP합성.png";
import hwahongmunPipImg from "@/assets/suwon/화홍문_PIP합성.png";
import bangwhasuryujeongPipImg from "@/assets/suwon/방화수류정_PIP합성.png";
import muralPipImg from "@/assets/suwon/벽화마을_PIP합성.png";
import haengridangilPipImg from "@/assets/suwon/행리단길_PIP합성.png";
...
const ROUND_TRIP = {
  ...
  homeArriveTime: "18:10", // 수원역(17:10) → 서울역, 1호선 왕복이라 갈 때와 동일하게 약 60분 (2026-07-22 수정 — 기존 30분은 노선 불일치 오류)
  bufferMinutes: 330 as number | null, // 귀환 소요시간 정정(30분→60분)에 맞춰 여유시간도 360→330분으로 재계산
};
...
const UI: Record<Lang, {
  ...
  ko: {
    ...
    evidenceItem1: "✓ 08:40 서울역 출발 → 18:10 서울역 귀환 (1호선 왕복)",
    evidenceItem2: "✓ 막차까지 여유 충분 (약 330분)",
    ...
    ch1: "과몰입 촬영지 BEST 6", ch2: "현지인 찐맛집", ch3: "카페", ch4: "한눈에 보는 당일치기 타임테이블",
  ...
  en: {
    ...
    evidenceItem1: "✓ 08:40 Depart Seoul Station → 18:10 Return Seoul Station (Line 1)",
    evidenceItem2: "✓ Plenty of time before the last train (~330 min)",
    ...
    verdictReasonPre: "You'll have ", verdictReasonPost: " before the last train (around midnight) — plenty of room to get back safely.",
    ...
    ch1: "Obsession-worthy filming spots BEST 6", ch2: "Local favorite restaurant", ch3: "Café", ch4: "Day-trip timetable at a glance",
    ...
    stickyHook: "This verdict might differ on the day you go",
  ...
  ja: {
    ...
    evidenceItem1: "✓ 08:40 ソウル駅出発 → 18:10 ソウル駅帰着（1号線往復）",
    evidenceItem2: "✓ 終電まで十分な余裕（約330分）",
    ...
    verdictReasonPre: "終電（深夜0時ごろ）まで", verdictReasonPost: "の余裕があります — 安心して帰れます。",
    ...
    ch1: "過剰入魂ロケ地 BEST 6", ch2: "地元グルメ", ch3: "カフェ", ch4: "ひと目でわかる日帰りタイムテーブル",
  ...
  zh: {
    ...
    evidenceItem1: "✓ 08:40 首尔站出发 → 18:10 首尔站返回（1号线往返）",
    evidenceItem2: "✓ 距末班车还有充足时间（约330分钟）",
    ...
    verdictReasonPre: "距末班车（接近午夜）还有", verdictReasonPost: "——可以放心返回。",
    ...
    ch1: "沉浸式取景地 BEST 6", ch2: "本地人气美食", ch3: "咖啡店", ch4: "一目了然的一日游时间表",
  ...
  vi: {
    ...
    evidenceItem1: "✓ 08:40 Xuất phát Ga Seoul → 18:10 Trở về Ga Seoul (Tuyến 1)",
    evidenceItem2: "✓ Còn nhiều thời gian trước chuyến tàu cuối (khoảng 330 phút)",
    ...
    verdictReasonPre: "Bạn còn ", verdictReasonPost: " trước chuyến tàu cuối (khoảng nửa đêm) — có thể yên tâm quay về.",
    ...
    ch1: "6 Điểm quay phim ấn tượng nhất", ch2: "Món ngon địa phương", ch3: "Quán cà phê", ch4: "Bảng giờ giấc đi trong ngày trong nháy mắt",
    ...
    stickyHook: "Nhận định này có thể khác vào ngày bạn đi",
...
const SPOTS: Record<Lang, SpotItem[]> = {
  ko: [
    { no: "01", emoji: "🎬", title: "몽테드 카페", subtitle: "솔이네 비디오가게 앞 · 노란 우산씬",
      ...
      caution: "영업시간 10:00–19:00 · 매주 수요일 휴무", image: monteDPipImg, imgAspect: "5 / 4", imgPosition: "bottom" },
    { no: "02", emoji: "💌", title: "화홍문", subtitle: "솔이가 선재에게 고백한 곳",
      ...
      caution: "24시간 개방 · 휴무 없음", image: hwahongmunPipImg, imgPosition: "top" },
    { no: "03", emoji: "🚲", title: "방화수류정", subtitle: "자전거를 가르쳐주던 그 자리",
      ...
      caution: "24시간 개방 · 휴무 없음", image: bangwhasuryujeongPipImg, imgPosition: "top" },
    { no: "04", emoji: "🧱", title: "행궁동 벽화마을", subtitle: "설레는 벽쿵씬 그 골목",
      ...
      caution: "개별 가게는 방문 시 영업 여부 확인 필요", image: muralPipImg, imgPosition: "top" },
    ...
    { no: "06", emoji: "🛍️", title: "행리단길", subtitle: "매일 지나던 그 등하굣길",
      scene: "선재가 매일 걷던 등하굣길, 그 거리를 따라 걷는 구간이에요.",
      coord: "경기 수원시 팔달구 신풍로 일대", move: "행리단길 → 정지영 커피 로스터즈, 도보로 이동",
      goldenHour: "가로수 늘어선 골목을 따라 천천히 걸으며 소품샵 구경하기 좋은 구간이에요.",
      caution: "개별 매장은 방문 시 영업 여부 확인 필요", image: haengridangilPipImg, imgPosition: "top" },
  ],
  en: [
    { no: "01", emoji: "🎬", title: "Monde Café", subtitle: "In front of Sol's video store · the yellow umbrella scene",
      ...
      caution: "Open 10:00–19:00 · Closed Wednesdays", image: monteDPipImg, imgAspect: "5 / 4", imgPosition: "bottom" },
    { no: "02", emoji: "💌", title: "Hwahongmun", subtitle: "Where Sol confessed to Sun-jae",
      ...
      caution: "Open 24 hours · No closed days", image: hwahongmunPipImg, imgPosition: "top" },
    { no: "03", emoji: "🚲", title: "Banghwasuryujeong", subtitle: "Where he taught her to ride a bike",
      ...
      caution: "Open 24 hours · No closed days", image: bangwhasuryujeongPipImg, imgPosition: "top" },
    { no: "04", emoji: "🧱", title: "Haenggung-dong Mural Village", subtitle: "The alley of the flustering wall-kiss scene",
      ...
      caution: "Check individual shop hours on visit", image: muralPipImg, imgPosition: "top" },
    ...
    { no: "06", emoji: "🛍️", title: "Haengridan-gil", subtitle: "The street she walked to school every day",
      scene: "The school-commute street Sun-jae walked every day — this stretch follows that same path.",
      coord: "경기 수원시 팔달구 신풍로 일대", move: "Haengridan-gil → Jeong Jiyoung Coffee Roasters, on foot",
      goldenHour: "A good stretch to stroll slowly under the tree-lined alley and browse the boutique shops.",
      caution: "Check individual shop hours on visit", image: haengridangilPipImg, imgPosition: "top" },
  ],
  ja: [
    { no: "01", emoji: "🎬", title: "モンテドカフェ", subtitle: "ソルの家のビデオ店前・黄色い傘のシーン",
      ...
      caution: "営業時間10:00–19:00 · 毎週水曜休み", image: monteDPipImg, imgAspect: "5 / 4", imgPosition: "bottom" },
    { no: "02", emoji: "💌", title: "華虹門", subtitle: "ソルがソンジェに告白した場所",
      ...
      caution: "24時間開放 · 休みなし", image: hwahongmunPipImg, imgPosition: "top" },
    { no: "03", emoji: "🚲", title: "訪花随柳亭", subtitle: "自転車を教えてもらったその場所",
      ...
      caution: "24時間開放 · 休みなし", image: bangwhasuryujeongPipImg, imgPosition: "top" },
    { no: "04", emoji: "🧱", title: "行宮洞壁画村", subtitle: "ドキドキする壁ドンシーンのあの路地",
      ...
      caution: "個別の店舗は訪問時に営業確認が必要", image: muralPipImg, imgPosition: "top" },
    ...
    { no: "06", emoji: "🛍️", title: "行理団街", subtitle: "毎日通っていたあの通学路",
      scene: "ソンジェが毎日歩いていた通学路、その道をたどる区間です。",
      coord: "경기 수원시 팔달구 신풍로 일대", move: "行理団街→ジョンジヨンコーヒーロースターズ、徒歩移動",
      goldenHour: "並木道をゆっくり歩きながら雑貨店を眺めるのにいい区間です。",
      caution: "個別の店舗は訪問時に営業確認が必要", image: haengridangilPipImg, imgPosition: "top" },
  ],
  zh: [
    { no: "01", emoji: "🎬", title: "Monde咖啡", subtitle: "Sol家录像店门前·黄色雨伞那场戏",
      ...
      caution: "营业时间10:00–19:00 · 每周三休息", image: monteDPipImg, imgAspect: "5 / 4", imgPosition: "bottom" },
    { no: "02", emoji: "💌", title: "花虹门", subtitle: "Sol向Sunjae表白的地方",
      ...
      caution: "24小时开放 · 无休息日", image: hwahongmunPipImg, imgPosition: "top" },
    { no: "03", emoji: "🚲", title: "访花随柳亭", subtitle: "教她骑自行车的地方",
      ...
      caution: "24小时开放 · 无休息日", image: bangwhasuryujeongPipImg, imgPosition: "top" },
    { no: "04", emoji: "🧱", title: "行宫洞壁画村", subtitle: "心动壁咚场景的那条巷子",
      ...
      caution: "个别店铺需现场确认营业情况", image: muralPipImg, imgPosition: "top" },
    ...
    { no: "06", emoji: "🛍️", title: "行理团街", subtitle: "每天走过的那条上学路",
      scene: "Sunjae每天走过的上学路，沿着这条街漫步的区间。",
      coord: "경기 수원시 팔달구 신풍로 일대", move: "行理团街→Jeong Jiyoung咖啡烘焙坊，步行前往",
      goldenHour: "沿着林荫小巷慢慢走，逛逛杂货店的好区间。",
      caution: "个别店铺需现场确认营业情况", image: haengridangilPipImg, imgPosition: "top" },
  ],
  vi: [
    { no: "01", emoji: "🎬", title: "Monde Café", subtitle: "Trước tiệm băng đĩa của Sol · Cảnh ô vàng",
      ...
      caution: "Giờ mở cửa 10:00–19:00 · Đóng cửa thứ Tư hàng tuần", image: monteDPipImg, imgAspect: "5 / 4", imgPosition: "bottom" },
    { no: "02", emoji: "💌", title: "Cổng Hwahongmun", subtitle: "Nơi Sol tỏ tình với Sun-jae",
      ...
      caution: "Mở cửa 24/24 · Không ngày nghỉ", image: hwahongmunPipImg, imgPosition: "top" },
    { no: "03", emoji: "🚲", title: "Banghwasuryujeong", subtitle: "Nơi anh ấy dạy cô đi xe đạp",
      ...
      caution: "Mở cửa 24/24 · Không ngày nghỉ", image: bangwhasuryujeongPipImg, imgPosition: "top" },
    { no: "04", emoji: "🧱", title: "Làng bích họa Haenggung-dong", subtitle: "Con hẻm nhỏ với cảnh ép tường lãng mạn",
      ...
      caution: "Cần xác nhận giờ mở cửa của từng cửa hàng riêng lẻ khi ghé thăm", image: muralPipImg, imgPosition: "top" },
    ...
    { no: "06", emoji: "🛍️", title: "Haengridan-gil", subtitle: "Con đường đến trường mỗi ngày",
      scene: "Con đường Sun-jae đi học mỗi ngày — đoạn đường này đi theo lối đó.",
      coord: "경기 수원시 팔달구 신풍로 일대", move: "Haengridan-gil → Jeong Jiyoung Coffee Roasters, đi bộ",
      goldenHour: "Đoạn đường đẹp để dạo bộ chậm rãi dưới hàng cây và ngắm các cửa hàng lưu niệm.",
      caution: "Cần xác nhận giờ mở cửa của từng cửa hàng riêng lẻ khi ghé thăm", image: haengridangilPipImg, imgPosition: "top" },
  ],
};
