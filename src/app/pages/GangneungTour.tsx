...
const EATS: EatItem[] = [
  {
    section: "food", emoji: "🐟", category: "점심 · 물회", title: "영진횟집",
    coord: "강릉시 주문진읍 주문진항 일대",
    tip: "주문진항 대표 물회 맛집. 도깨비촬영지 관람 직후 시티1로 5분 거리.",
    view: "동해 활어를 바로 앞에서 맛볼 수 있는 주문진항 현지 맛집. 도깨비촬영지 다음 코스로 바로 연결돼요.",
    image: gangneungPlaceholderImg,
  },
  {
...
const TIMETABLE: TimetableItem[] = [
  ...
  { time: "12:27", emoji: "🐟", label: "주문진항 점심 — 영진횟집", desc: "동해 활어 물회 (체류 약 1시간)" },
  ...
  { time: "17:12", emoji: "🚌", label: "강릉중앙시장으로 이동", desc: "⚠️ 보사노바→강릉중앙시장 이동수단 팀 현장 확인 필요 (현재 안목해변 버스→강릉역 약 30분+도보 15분으로 추정)" },
  { time: "17:42", emoji: "🏪", label: "강릉중앙시장", desc: "오징어순대·명태회·메밀부침 등 시장 골목 구경 (체류 약 45분)" },
