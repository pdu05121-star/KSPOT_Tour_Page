...
import { MapPin, ArrowRight, Mail, User, ChevronLeft, Star, Clock, CheckCircle2, Footprints, Flame, Calendar, HelpCircle } from "lucide-react";
...
const galleryImages = [
  "https://images.unsplash.com/photo-1601042879364-f3947d3f9c16?w=1200&h=800&fit=crop&auto=format", // 성곽 메인
  "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=1200&h=800&fit=crop&auto=format", // 솔선 골목
  "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=1200&h=800&fit=crop&auto=format", // 화홍문 징검다리
  "https://images.unsplash.com/photo-1583422409516-2895a77efded?w=1200&h=800&fit=crop&auto=format", // 벽화 골목
];
...
const steps = [
  ...
  { label: "안내", desc: "72시간 내 투어 가이드 메일 발송" },
...
export default function App() {
  ...
  return (
    <div
      className="min-h-screen bg-gray-50 text-foreground"
      style={{
    ...
    >
      ...
      <nav className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <span className="text-xl font-extrabold tracking-wider" style={{ color: TEAL_DARK }}>
            KSPOT
          </span>
          <div style={{ width: 80 }} />
        </div>
          ...
          <div className="lg:col-span-7 flex flex-col gap-4">
            <div className="relative aspect-video lg:aspect-[4/3] rounded-2xl overflow-hidden shadow-sm bg-gray-100">
              ...
              <div className="absolute top-4 left-4 flex gap-2">
                <Badge className="bg-[#1D9E75] text-white hover:bg-[#15805d] font-bold px-3 py-1 text-xs">
                  📍 수원 행궁동
                </Badge>
                <Badge className="bg-orange-500 text-white hover:bg-orange-600 font-bold px-3 py-1 text-xs flex gap-1 items-center">
            ...
            <div className="lg:sticky lg:top-20 bg-white rounded-2xl p-6 border border-gray-100 shadow-md">
              ...
              <div className="space-y-3 mb-6 bg-gray-50 p-4 rounded-xl text-xs font-bold text-gray-700">
                <div className="flex justify-between items-center">
                  ...
                  <span>약 6시간 (당일치기)</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-400 flex items-center gap-1.5 font-semibold">
                    <Footprints size={14} /> 여행 난이도
                  </span>
                  <span>보통 (완만한 성곽길 도보 위주)</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-400 flex items-center gap-1.5 font-semibold">
              ...
              <div className="hidden md:block">
                {submitted ? (
                  <div className="bg-[#E8F5F0] rounded-xl p-5 border border-[#c3e8da] text-center">
                    ...
                    <p className="font-extrabold text-[#0F6E56] text-sm">무료 신청 완료!</p>
                    <p className="text-xs text-[#0F6E56]/80 mt-1 font-semibold">
                      10분 내로 <strong>{email}</strong>로 가이드가 발송됩니다.
                    </p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    >
                      {submitting ? "신청 처리 중..." : "🔒 지금 무료로 가이드북 받기"}
                    </button>
                  </form>
                )}
              </div>
                        ...
                        <div className="md:col-span-3 p-6 flex flex-col gap-4">
                          ...
                          <div className="space-y-3.5 text-xs font-semibold leading-relaxed">
                            ...
                            <div>
                              ...
                              <p className="text-gray-600 pl-1">{s.reality}</p>
                            </div>
                          </div>
                          ...
                          <div className="bg-[#E8F5F0] border border-[#c3e8da] rounded-xl px-4 py-3 text-[11px] font-bold text-[#0F6E56] leading-relaxed">
                            ...
                            <p className="font-semibold">{s.photoTip}</p>
                          </div>
                          ...
                          <div className="bg-[#FFFBEB] border border-[#fde68a] rounded-xl px-4 py-3 text-[11px] font-bold text-[#78350f] leading-relaxed">
                            ...
                            <p className="font-semibold">{s.warning}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    {timeline.map((t, idx) => (
                      <div key={idx} className="relative flex flex-col sm:flex-row items-start gap-4">
                        <div className="absolute left-0 w-8 sm:w-24 text-left sm:text-right font-extrabold text-xs sm:text-sm pt-2 text-gray-400">
                          {t.time}
                        </div>
                        ...
                        <div className="flex-1 w-full pl-6 sm:pl-8">
                          <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
                            <div className="flex items-center gap-2 mb-1.5">
                              ...
                              <Badge className="bg-[#E8F5F0] text-[#0F6E56] hover:bg-[#c3e8da] font-bold text-[10px]">
                                {t.spot}
                              </Badge>
                            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="rounded-2xl border border-gray-100 overflow-hidden bg-white shadow-sm flex flex-col">
                    <div className="relative aspect-video bg-gray-100">
                      <img
                        src="https://images.unsplash.com/photo-1617196034183-421b4040ed20?w=600&h=400&fit=crop&auto=format"
                        alt="수원 왕갈비 통닭"
                        className="w-full h-full object-cover"
                      />
                      <Badge className="absolute top-3 left-3 bg-yellow-500 text-white font-bold">맛집</Badge>
                    </div>
                  ...
                  <div className="rounded-2xl border border-gray-100 overflow-hidden bg-white shadow-sm flex flex-col">
                    <div className="relative aspect-video bg-gray-100">
                      <img
                        src="https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=600&h=400&fit=crop&auto=format"
                        alt="우디38 루프탑 카페"
                        className="w-full h-full object-cover"
                      />
                      <Badge className="absolute top-3 left-3 bg-gray-900 text-white font-bold">카페</Badge>
                    </div>
                    <div className="p-5 flex-1 flex flex-col justify-between">
                      <div>
                        <h3 className="font-extrabold text-sm text-gray-900 mb-2">☕ 행궁 루프탑 카페 '우디38'</h3>
                        <p className="text-xs font-semibold text-gray-500 leading-relaxed mb-4">
                          옥상에 오르는 순간 탁 트인 성벽 기와 지붕 뷰가 한눈에 펼쳐지는 숨은 노을 맛집 🌇
                        </p>
                      </div>
                      <div className="space-y-3">
                        <div className="flex items-start gap-1.5 bg-gray-50 rounded-xl p-2.5 text-[11px] font-semibold text-gray-700">
              ...
              <div className="max-w-3xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 bg-gray-50 rounded-2xl p-6 border border-gray-100 gap-6 text-center md:text-left mb-8 items-center">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="flex items-center gap-0.5 text-yellow-400 my-1">
                      {[...Array(5)].map((_, i) => (
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="flex items-center gap-1.5">
                              ...
                              <Badge className="bg-gray-100 hover:bg-gray-200 text-gray-600 font-bold text-[9px] px-1.5 py-0.5">
                                {r.tag}
                              </Badge>
                            </div>
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    {faqs.map((faq, idx) => (
                      <AccordionItem key={idx} value={`item-${idx}`} className="border-b border-gray-100">
                        <AccordionTrigger className="text-xs font-bold text-gray-800 hover:text-[#1D9E75]">
                          Q. {faq.q}
                        </AccordionTrigger>
                        <AccordionContent className="text-xs text-gray-600 font-semibold leading-relaxed">
                          {faq.a}
                        </AccordionContent>
                      </AccordionItem>
                    ))}
      ...
      <footer className="border-t border-gray-100 bg-white py-12 px-4 pb-24 md:pb-12">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <span className="font-black text-base tracking-wider" style={{ color: TEAL_DARK }}>
            KSPOT
          </span>
          <a
            href="#"
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 px-5 py-3.5 flex items-center justify-between shadow-2xl">
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription className="text-xs font-semibold text-gray-500">
                성함과 메일 주소를 남겨주시면 10분 내로 구글맵 핀과 상세 가이드를 발송해 드립니다.
              </DialogDescription>
            </DialogHeader>

            {submitted ? (
              <div className="bg-[#E8F5F0] rounded-xl p-5 border border-[#c3e8da] text-center my-4">
                <p className="text-2xl mb-1">🎉</p>
                <p className="font-extrabold text-[#0F6E56] text-xs">신청이 정상 접수되었습니다!</p>
                <p className="text-[10px] text-[#0F6E56]/80 mt-1 font-semibold">
                  적어주신 메일 <strong>{email}</strong>을 확인해 주세요.
                </p>
              </div>
            ) : (
